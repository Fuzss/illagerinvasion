...
//    public static final RegistryReference<Instrument> REVEAL_INSTRUMENT = REGISTRY.register(Registries.INSTRUMENT, "reveal", () -> new Instrument(ModRegistry.HORN_OF_SIGHT_SOUND_EVENT.holder(), 120, 48.0F));
    ...
    public static final RegistryReference<StructurePoolElementType<SinglePoolElement>> SINGLE_POOL_ELEMENT_TYPE = REGISTRY.register(Registry.STRUCTURE_POOL_ELEMENT_REGISTRY, "single_pool_element", () -> () -> DrySinglePoolElement.CODEC);
    public static final RegistryReference<StructurePoolElementType<LegacySinglePoolElement>> LEGACY_SINGLE_POOL_ELEMENT_TYPE = REGISTRY.register(Registry.STRUCTURE_POOL_ELEMENT_REGISTRY, "legacy_single_pool_element", () -> () -> DryLegacySinglePoolElement.CODEC);
