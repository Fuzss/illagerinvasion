...
public class SurrenderedRenderer extends HumanoidMobRenderer<Surrendered, SurrenderedRenderState, SurrenderedModel> {
    ...
    public SurrenderedRenderer(EntityRendererProvider.Context context) {
        super(context, new SurrenderedModel(context.bakeLayer(ModelLayerLocations.SURRENDERED)), 0.5F);
        this.addLayer(new HumanoidArmorLayer<>(this,
                new SurrenderedModel(context.bakeLayer(ModelLayerLocations.SURRENDERED_INNER_ARMOR)),
                new SurrenderedModel(context.bakeLayer(ModelLayerLocations.SURRENDERED_OUTER_ARMOR)),
