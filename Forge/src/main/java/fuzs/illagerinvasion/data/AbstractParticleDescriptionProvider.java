...
public abstract class AbstractParticleDescriptionProvider extends JsonCodecProvider<List<ResourceLocation>> {
    ...
    public AbstractParticleDescriptionProvider(PackOutput packOutput, ExistingFileHelper fileHelper) {
        this(packOutput, fileHelper, Maps.newHashMap());
    }

    private AbstractParticleDescriptionProvider(PackOutput packOutput, ExistingFileHelper fileHelper, Map<ResourceLocation, List<ResourceLocation>> entries) {
        super(packOutput, fileHelper, "", JsonOps.INSTANCE, PackType.CLIENT_RESOURCES, "particles", CODEC, entries);
