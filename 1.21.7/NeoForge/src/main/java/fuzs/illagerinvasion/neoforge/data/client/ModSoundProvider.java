...
public class ModSoundProvider extends AbstractSoundProvider {
    ...
    public void addSounds() {
        ...
        this.add(ModSoundEvents.ARCHIVIST_DEATH_SOUND_EVENT.value(),
                sound(this.id("mob/archivist/death1")),
                sound(this.id("mob/archivist/death2")),
                sound(this.id("mob/archivist/death3")));
        this.add(ModSoundEvents.ARCHIVIST_HURT_SOUND_EVENT.value(),
                sound(this.id("mob/archivist/hurt1")),
                sound(this.id("mob/archivist/hurt2")),
                sound(this.id("mob/archivist/hurt3")));
        this.add(ModSoundEvents.ARCHIVIST_AMBIENT_SOUND_EVENT.value(),
                sound(this.id("mob/archivist/idle1")),
                sound(this.id("mob/archivist/idle2")),
                sound(this.id("mob/archivist/idle3")));
        ...
        this.add(ModSoundEvents.BASHER_HURT_SOUND_EVENT.value(),
                sound(this.id("mob/basher/hurt1")),
                sound(this.id("mob/basher/hurt2")),
                sound(this.id("mob/basher/hurt3")));
        this.add(ModSoundEvents.BASHER_AMBIENT_SOUND_EVENT.value(),
                sound(this.id("mob/basher/idle1")),
                sound(this.id("mob/basher/idle2")),
                sound(this.id("mob/basher/idle3")));
        ...
        this.add(ModSoundEvents.FIRECALLER_DEATH_SOUND_EVENT.value(),
                sound(this.id("mob/firecaller/death1")),
                sound(this.id("mob/firecaller/death2")));
        this.add(ModSoundEvents.FIRECALLER_HURT_SOUND_EVENT.value(),
                sound(this.id("mob/firecaller/hurt1")),
                sound(this.id("mob/firecaller/hurt2")),
                sound(this.id("mob/firecaller/hurt3")));
        this.add(ModSoundEvents.FIRECALLER_AMBIENT_SOUND_EVENT.value(),
                sound(this.id("mob/firecaller/idle1")),
                sound(this.id("mob/firecaller/idle2")),
                sound(this.id("mob/firecaller/idle3")),
                sound(this.id("mob/firecaller/idle4")));
        ...
        this.add(ModSoundEvents.ILLAGER_BRUTE_HURT_SOUND_EVENT.value(),
                sound(this.id("mob/illager_brute/hurt1")),
                sound(this.id("mob/illager_brute/hurt2")),
                sound(this.id("mob/illager_brute/hurt3")));
        this.add(ModSoundEvents.ILLAGER_BRUTE_AMBIENT_SOUND_EVENT.value(),
                sound(this.id("mob/illager_brute/idle1")),
                sound(this.id("mob/illager_brute/idle2")),
                sound(this.id("mob/illager_brute/idle3")),
                sound(this.id("mob/illager_brute/idle4")),
                sound(this.id("mob/illager_brute/idle5")));
        ...
        this.add(ModSoundEvents.INVOKER_HURT_SOUND_EVENT.value(),
                sound(this.id("mob/invoker/hurt1")),
                sound(this.id("mob/invoker/hurt2")));
        this.add(ModSoundEvents.INVOKER_AMBIENT_SOUND_EVENT.value(),
                sound(this.id("mob/invoker/idle1")),
                sound(this.id("mob/invoker/idle2")),
                sound(this.id("mob/invoker/idle3")),
                sound(this.id("mob/invoker/idle4")));
        ...
        this.add(ModSoundEvents.PROVOKER_HURT_SOUND_EVENT.value(),
                sound(this.id("mob/provoker/hurt1")),
                sound(this.id("mob/provoker/hurt2")),
                sound(this.id("mob/provoker/hurt3")));
        this.add(ModSoundEvents.PROVOKER_AMBIENT_SOUND_EVENT.value(),
                sound(this.id("mob/provoker/idle1")),
                sound(this.id("mob/provoker/idle2")),
                sound(this.id("mob/provoker/idle3")));
        ...
        this.add(ModSoundEvents.SORCERER_COMPLETE_CAST_SOUND_EVENT.value(),
                sound(this.id("mob/sorcerer/completecast")));
        ...
        this.add(ModSoundEvents.SORCERER_HURT_SOUND_EVENT.value(),
                sound(this.id("mob/sorcerer/hurt1")),
                sound(this.id("mob/sorcerer/hurt2")),
                sound(this.id("mob/sorcerer/hurt3")));
        this.add(ModSoundEvents.SORCERER_AMBIENT_SOUND_EVENT.value(),
                sound(this.id("mob/sorcerer/idle1")),
                sound(this.id("mob/sorcerer/idle2")),
                sound(this.id("mob/sorcerer/idle3")),
                sound(this.id("mob/sorcerer/idle4")));
        ...
        this.add(ModSoundEvents.SURRENDERED_HURT_SOUND_EVENT.value(),
                sound(this.id("mob/surrendered/hurt1")),
                sound(this.id("mob/surrendered/hurt2")),
                sound(this.id("mob/surrendered/hurt3")));
        this.add(ModSoundEvents.SURRENDERED_AMBIENT_SOUND_EVENT.value(),
                sound(this.id("mob/surrendered/ambient1")),
                sound(this.id("mob/surrendered/ambient2")),
                sound(this.id("mob/surrendered/ambient3")));
    }
}
