...
public class PlatinumTrimHandler {
    public static final String INSIGHT_TRANSLATION_KEY =
            "trim_material." + IllagerInvasion.MOD_ID + ".platinum.effect.insight";
    public static final String AGILITY_TRANSLATION_KEY =
            "trim_material." + IllagerInvasion.MOD_ID + ".platinum.effect.agility";
    public static final String ENDURANCE_TRANSLATION_KEY =
            "trim_material." + IllagerInvasion.MOD_ID + ".platinum.effect.endurance";
    public static final String FEATHERWEIGHT_TRANSLATION_KEY =
            "trim_material." + IllagerInvasion.MOD_ID + ".platinum.effect.featherweight";
    public static final Map<EquipmentSlot, String> PLATINUM_TRIM_TRANSLATION_KEYS = Maps.immutableEnumMap(Map.of(
            EquipmentSlot.FEET,
            FEATHERWEIGHT_TRANSLATION_KEY,
            EquipmentSlot.LEGS,
            ENDURANCE_TRANSLATION_KEY,
            EquipmentSlot.CHEST,
            AGILITY_TRANSLATION_KEY,
            EquipmentSlot.HEAD,
            INSIGHT_TRANSLATION_KEY));
    ...
    public static EventResult onFarmlandTrample(Level level, BlockPos pos, BlockState state, float fallDistance, Entity entity) {
        return entity instanceof Player player && hasPlatinumTrim(player, EquipmentSlot.FEET) ? EventResult.INTERRUPT :
                EventResult.PASS;
    }
    ...
    public static Optional<ArmorTrim> getPlatinumTrim(Level level, ItemStack itemStack) {
        ...
        return armorTrim != null && armorTrim.material().is(ModRegistry.PLATINUM_TRIM_MATERIAL) ?
                Optional.of(armorTrim) : Optional.empty();
    }
}
