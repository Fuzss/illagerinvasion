...
public class ModRegistry {
    ...
    public static final Holder.Reference<StructurePoolElementType<SinglePoolElement>> SINGLE_POOL_ELEMENT_TYPE = REGISTRY.register(Registries.STRUCTURE_POOL_ELEMENT, "single_pool_element", () -> () -> DrySinglePoolElement.CODEC);
    public static final Holder.Reference<StructurePoolElementType<LegacySinglePoolElement>> LEGACY_SINGLE_POOL_ELEMENT_TYPE = REGISTRY.register(Registries.STRUCTURE_POOL_ELEMENT, "legacy_single_pool_element", () -> () -> DryLegacySinglePoolElement.CODEC);
