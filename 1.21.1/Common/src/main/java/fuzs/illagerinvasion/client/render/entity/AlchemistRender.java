...
public class AlchemistRender extends MobRenderer<Alchemist, IllagerModel<Alchemist>> {
    ...
    public AlchemistRender(final EntityRendererProvider.Context context) {
        super(context, new IllagerModel<>(context.bakeLayer(ClientModRegistry.BRIM_HAT_ILLAGER)), 0.5f);
