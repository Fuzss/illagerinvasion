...
public class BrimmedHatIllagerEntityModel<T extends AbstractIllager> extends HierarchicalModel<T> implements ArmedModel, HeadedModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        final PartDefinition partDefinition = modelData.getRoot();
        ...
        partDefinition3.addOrReplaceChild("brim", CubeListBuilder.create().texOffs(69, 47).addBox(-8.0F, -8.0F, -6.0F, 16.0F, 16.0F, 1.0F), PartPose.rotation(-1.5707964f, 0.0F, 0.0F));
        PartDefinition partDefinition4 = partDefinition.addOrReplaceChild("body",
                CubeListBuilder.create()
                        .texOffs(16, 20)
                        .addBox(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F)
                        .texOffs(0, 38)
                        .addBox(-4.0F, 0.0F, -3.0F, 8.0F, 20.0F, 6.0F, LayerDefinitions.INNER_ARMOR_DEFORMATION),
                PartPose.offset(0.0F, 0.0F, 0.0F));
        partDefinition4.addOrReplaceChild("belt",
                CubeListBuilder.create()
                        .texOffs(64, 11)
                        .addBox(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F, LayerDefinitions.OUTER_ARMOR_DEFORMATION),
                PartPose.ZERO);
