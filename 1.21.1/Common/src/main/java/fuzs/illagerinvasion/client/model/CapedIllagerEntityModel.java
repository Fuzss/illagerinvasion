...
public class CapedIllagerEntityModel<T extends AbstractIllager> extends HierarchicalModel<T> implements ArmedModel, HeadedModel {
    ...
    public static LayerDefinition getTexturedModelData() {
        ...
        partDefinition.addOrReplaceChild("body", CubeListBuilder.create().texOffs(16, 20).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 12.0F, 6.0F).texOffs(0, 38).addBox(-4.0F, 0.0F, -3.0F, 8.0F, 22.0F, 6.0F, new CubeDeformation(0.5f)), PartPose.offset(0.0F, 0.0F, 0.0F));
        ...
        partDefinition.addOrReplaceChild("cape", CubeListBuilder.create().texOffs(64, 0).addBox(-4.5F, 0.0F, 0.0F, 9.0F, 17.0F, 1.0F, new CubeDeformation(0.6f, 0.7f, 0.0F)), PartPose.offset(0.0F, 1.0F, 3.4f));
