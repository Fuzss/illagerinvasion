...
public class ModSoundEvents {
    ...
    public static final Holder.Reference<SoundEvent> LOST_CANDLE_DIAMOND_SOUND_EVENT = register("item.lost_candle.diamond");
    public static final Holder.Reference<SoundEvent> LOST_CANDLE_IRON_SOUND_EVENT = register("item.lost_candle.iron");
    public static final Holder.Reference<SoundEvent> LOST_CANDLE_COAL_SOUND_EVENT = register("item.lost_candle.coal");
    public static final Holder.Reference<SoundEvent> LOST_CANDLE_COPPER_SOUND_EVENT = register("item.lost_candle.copper");
    public static final Holder.Reference<SoundEvent> LOST_CANDLE_GOLD_SOUND_EVENT = register("item.lost_candle.gold");
    public static final Holder.Reference<SoundEvent> SURRENDERED_AMBIENT_SOUND_EVENT = register("entity.surrendered.ambient");
    public static final Holder.Reference<SoundEvent> SURRENDERED_HURT_SOUND_EVENT = register("entity.surrendered.hurt");
    public static final Holder.Reference<SoundEvent> SURRENDERED_CHARGE_SOUND_EVENT = register("entity.surrendered.charge");
    public static final Holder.Reference<SoundEvent> SURRENDERED_DEATH_SOUND_EVENT = register("entity.surrendered.death");
    public static final Holder.Reference<SoundEvent> NECROMANCER_SUMMON_SOUND_EVENT = register("entity.necromancer.summon");
    ...
    public static final Holder.Reference<SoundEvent> INVOKER_COMPLETE_CAST_SOUND_EVENT = register("entity.invoker.completecast");
    public static final Holder.Reference<SoundEvent> INVOKER_TELEPORT_CAST_SOUND_EVENT = register("entity.invoker.teleport_cast");
    public static final Holder.Reference<SoundEvent> INVOKER_FANGS_CAST_SOUND_EVENT = register("entity.invoker.fangs_cast");
    public static final Holder.Reference<SoundEvent> INVOKER_BIG_CAST_SOUND_EVENT = register("entity.invoker.big_cast");
    public static final Holder.Reference<SoundEvent> INVOKER_SUMMON_CAST_SOUND_EVENT = register("entity.invoker.summon_cast");
    public static final Holder.Reference<SoundEvent> INVOKER_SHIELD_BREAK_SOUND_EVENT = register("entity.invoker.shield_break");
    public static final Holder.Reference<SoundEvent> INVOKER_SHIELD_CREATE_SOUND_EVENT = register("entity.invoker.shield_create");
    public static final Holder.Reference<SoundEvent> ILLAGER_BRUTE_AMBIENT_SOUND_EVENT = register("entity.illager_brute.ambient");
    public static final Holder.Reference<SoundEvent> ILLAGER_BRUTE_HURT_SOUND_EVENT = register("entity.illager_brute.hurt");
    public static final Holder.Reference<SoundEvent> ILLAGER_BRUTE_DEATH_SOUND_EVENT = register("entity.illager_brute.death");
    ...
    public static final Holder.Reference<SoundEvent> PROVOKER_CELEBRATE_SOUND_EVENT = register("entity.provoker.celebrate");
    ...
    public static final Holder.Reference<SoundEvent> SORCERER_COMPLETE_CAST_SOUND_EVENT = register("entity.sorcerer.complete_cast");
    ...
    public static final Holder.Reference<SoundEvent> SORCERER_CELEBRATE_SOUND_EVENT = register("entity.sorcerer.celebrate");
