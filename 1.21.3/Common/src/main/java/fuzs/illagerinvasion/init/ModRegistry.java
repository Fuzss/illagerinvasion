...
public class ModRegistry {
    ...
    public static final Holder.Reference<Instrument> REVEAL_INSTRUMENT = REGISTRIES.register(Registries.INSTRUMENT, "reveal", () -> new Instrument(
            ModSoundEvents.HORN_OF_SIGHT_SOUND_EVENT, 120, 48.0F));
