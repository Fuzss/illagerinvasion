...
public enum ModArmorMaterial implements ArmorMaterial {
    PLATINUM_INFUSED_NETHERITE("platinum_infused_netherite", 40, new int[]{3, 6, 8, 3}, 17, SoundEvents.ARMOR_EQUIP_NETHERITE, 3.0f, 0.2f, () -> Ingredient.of(ItemRegistry.PLATINUM_SHEET));
