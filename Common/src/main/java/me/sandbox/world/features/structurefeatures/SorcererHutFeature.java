...
public class SorcererHutFeature extends StructureFeature<JigsawConfiguration> {

    public SorcererHutFeature() {
        super(JigsawConfiguration.CODEC, SorcererHutFeature::createPiecesGenerator, PostPlacementProcessor.NONE);
    }
