...
import me.sandbox.entity.ai.goal.PotionBowAttackGoal;
...
public class Alchemist extends AbstractIllager implements RangedAttackMob {
    private static final EntityDataAccessor<Boolean> POTION = SynchedEntityData.defineId(Alchemist.class, EntityDataSerializers.BOOLEAN);
    private static final EntityDataAccessor<Boolean> BOW = SynchedEntityData.defineId(Alchemist.class, EntityDataSerializers.BOOLEAN);
    ...
    protected void defineSynchedData() {
        this.entityData.define(Alchemist.POTION, false);
        this.entityData.define(Alchemist.BOW, true);
    ...
    public boolean getBowState() {
        return this.entityData.get(Alchemist.BOW);
    }

    public void setBowState(final boolean bowState) {
        this.entityData.set(Alchemist.BOW, bowState);
    }
