...
import me.sandbox.util.EnchantToolUtil;
...
public class Archivist extends SpellcasterIllager {
    ...
    public SoundEvent getCelebrateSound() {
        return ModRegistry.ARCHIVIST_AMBIENT_SOUND_EVENT;
    }
    ...
    protected SoundEvent getDeathSound() {
        return ModRegistry.ARCHIVIST_DEATH_SOUND_EVENT;
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource source) {
        return ModRegistry.ARCHIVIST_HURT_SOUND_EVENT;
    }
    ...
    public class EnchantAllyGoal extends SpellcasterIllager.SpellcasterUseSpellGoal {
        ...
        public boolean canEnchant() {
            ...
            return this.enchantToolUtil.eligibleForEnchant(hostileEntity);
        }
        ...
        protected void performSpellCasting() {
            ...
            this.enchantToolUtil.enchantHeldGear(hostileEntity);
