...
public class Surrendered extends Skeleton {
    ...
    protected SoundEvent getAmbientSound() {
        return ModRegistry.SURRENDERED_AMBIENT_SOUND_EVENT;
    }

    @Override
    protected SoundEvent getDeathSound() {
        return ModRegistry.SURRENDERED_DEATH_SOUND_EVENT;
    }

    @Override
    protected SoundEvent getHurtSound(DamageSource source) {
        return ModRegistry.SURRENDERED_HURT_SOUND_EVENT;
    }
    ...
    class ChargeTargetGoal extends Goal {
        ...
        public void start() {
            ...
            Surrendered.this.playSound(ModRegistry.SURRENDERED_CHARGE_SOUND_EVENT, 1.0f, 1.0f);
        }
