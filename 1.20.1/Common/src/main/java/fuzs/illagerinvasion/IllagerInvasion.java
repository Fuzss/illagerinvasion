...
public class IllagerInvasion implements ModConstructor {
    ...
    private static void injectLootPool(ResourceLocation identifier, Consumer<LootPool> addPool, ResourceLocation builtInLootTable, ResourceLocation injectedLootTable) {
        if (identifier.equals(builtInLootTable)) {
            addPool.accept(LootPool.lootPool()
                    ...
                    .add(LootTableReference.lootTableReference(injectedLootTable))
                    .build());
        }
    }
    ...
    private static void registerRaiderTypes() {
        registerRaiderType(ModRegistry.BASHER_ENTITY_TYPE, RaidWavesConfigHelper.BASHER_RAID_WAVES);
        registerRaiderType(ModRegistry.PROVOKER_ENTITY_TYPE, RaidWavesConfigHelper.PROVOKER_RAID_WAVES);
        registerRaiderType(ModRegistry.NECROMANCER_ENTITY_TYPE, RaidWavesConfigHelper.NECROMANCER_RAID_WAVES);
        registerRaiderType(ModRegistry.SORCERER_ENTITY_TYPE, RaidWavesConfigHelper.SORCERER_RAID_WAVES);
        registerRaiderType((Holder.Reference<? extends EntityType<? extends Raider>>) (Holder.Reference<?>) EntityType.ILLUSIONER.builtInRegistryHolder(),
                RaidWavesConfigHelper.ILLUSIONER_RAID_WAVES);
        registerRaiderType(ModRegistry.ARCHIVIST_ENTITY_TYPE, RaidWavesConfigHelper.ARCHIVIST_RAID_WAVES);
        registerRaiderType(ModRegistry.MARAUDER_ENTITY_TYPE, RaidWavesConfigHelper.MARAUDER_RAID_WAVES);
        registerRaiderType(ModRegistry.INQUISITOR_ENTITY_TYPE, RaidWavesConfigHelper.INQUISITOR_RAID_WAVES);
        registerRaiderType(ModRegistry.ALCHEMIST_ENTITY_TYPE, RaidWavesConfigHelper.ALCHEMIST_RAID_WAVES);
        registerRaiderType(ModRegistry.INVOKER_ENTITY_TYPE, RaidWavesConfigHelper.INVOKER_RAID_WAVES);
    }
    ...
    private static void registerRaiderType(Holder.Reference<? extends EntityType<? extends Raider>> holder, int[] spawnsPerWaveBeforeBonus) {
        registerRaiderType(holder.key(), holder.value(), spawnsPerWaveBeforeBonus);
    }
    ...
    private static void registerRaiderType(RegistryReference<? extends EntityType<? extends Raider>> registryReference, int[] spawnsPerWaveBeforeBonus) {
        registerRaiderType(registryReference.getResourceKey(), registryReference.get(), spawnsPerWaveBeforeBonus);
    }
    ...
    private static void registerRaiderType(ResourceKey<? extends EntityType<? extends Raider>> resourceKey, EntityType<? extends Raider> entityType, int[] spawnsPerWaveBeforeBonus) {
        CommonAbstractions.INSTANCE.registerRaiderType(resourceKey.location()
                .toDebugFileName()
                .toUpperCase(Locale.ROOT), entityType, spawnsPerWaveBeforeBonus);
    }

    private static void registerPotionRecipes() {
        PotionBrewingRegistry.INSTANCE.registerPotionRecipe(Potions.AWKWARD,
                Items.GOAT_HORN,
                ModRegistry.BERSERKING_POTION.get());
        PotionBrewingRegistry.INSTANCE.registerPotionRecipe(ModRegistry.BERSERKING_POTION.get(),
                Items.REDSTONE,
                ModRegistry.LONG_BERSERKING_POTION.get());
        PotionBrewingRegistry.INSTANCE.registerPotionRecipe(ModRegistry.BERSERKING_POTION.get(),
                Items.GLOWSTONE_DUST,
                ModRegistry.STRONG_BERSERKING_POTION.get());
    }

    @Override
    public void onEntityAttributeCreation(EntityAttributesCreateContext context) {
        context.registerEntityAttributes(ModRegistry.ALCHEMIST_ENTITY_TYPE.get(),
                Monster.createMonsterAttributes()
                        .add(Attributes.MAX_HEALTH, 24.0)
                        .add(Attributes.MOVEMENT_SPEED, 0.38));
        context.registerEntityAttributes(ModRegistry.ARCHIVIST_ENTITY_TYPE.get(),
                Monster.createMonsterAttributes()
                        .add(Attributes.MAX_HEALTH, 24.0D)
                        .add(Attributes.MOVEMENT_SPEED, 0.36D));
        context.registerEntityAttributes(ModRegistry.BASHER_ENTITY_TYPE.get(),
                Monster.createMonsterAttributes()
                        .add(Attributes.MAX_HEALTH, 32.0D)
                        .add(Attributes.MOVEMENT_SPEED, 0.31D)
                        .add(Attributes.ATTACK_DAMAGE, 3.0D)
                        .add(Attributes.ATTACK_KNOCKBACK, 0.2D));
        context.registerEntityAttributes(ModRegistry.FIRECALLER_ENTITY_TYPE.get(),
                Monster.createMonsterAttributes()
                        .add(Attributes.MAX_HEALTH, 32.0)
                        .add(Attributes.MOVEMENT_SPEED, 0.38));
        context.registerEntityAttributes(ModRegistry.INQUISITOR_ENTITY_TYPE.get(),
                Monster.createMonsterAttributes()
        ...
        context.registerEntityAttributes(ModRegistry.INVOKER_ENTITY_TYPE.get(),
                Monster.createMonsterAttributes()
                        .add(Attributes.MAX_HEALTH, 250.0D)
                        .add(Attributes.MOVEMENT_SPEED, 0.36D)
                        .add(Attributes.KNOCKBACK_RESISTANCE, 0.3D)
                        .add(Attributes.ATTACK_DAMAGE, 8.0D));
        context.registerEntityAttributes(ModRegistry.MARAUDER_ENTITY_TYPE.get(),
                Monster.createMonsterAttributes()
                        .add(Attributes.MAX_HEALTH, 24.0D)
                        .add(Attributes.MOVEMENT_SPEED, 0.30D));
        context.registerEntityAttributes(ModRegistry.PROVOKER_ENTITY_TYPE.get(),
                Monster.createMonsterAttributes()
                        .add(Attributes.MAX_HEALTH, 24.0D)
                        .add(Attributes.MOVEMENT_SPEED, 0.38D));
        context.registerEntityAttributes(ModRegistry.SORCERER_ENTITY_TYPE.get(),
                Monster.createMonsterAttributes()
                        .add(Attributes.MAX_HEALTH, 32.0D)
                        .add(Attributes.MOVEMENT_SPEED, 0.38D));
        context.registerEntityAttributes(ModRegistry.SURRENDERED_ENTITY_TYPE.get(),
                Monster.createMonsterAttributes()
                        .add(Attributes.MAX_HEALTH, 14.0D)
                        .add(Attributes.ATTACK_DAMAGE, 5.0D));
        context.registerEntityAttributes(ModRegistry.NECROMANCER_ENTITY_TYPE.get(),
                Monster.createMonsterAttributes()
                        .add(Attributes.MAX_HEALTH, 32.0)
                        .add(Attributes.MOVEMENT_SPEED, 0.38));
    }
    ...
    public void onRegisterSpawnPlacements(SpawnPlacementsContext context) {
        context.registerSpawnPlacement(ModRegistry.ALCHEMIST_ENTITY_TYPE.get(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                PatrollingMonster::checkPatrollingMonsterSpawnRules);
        context.registerSpawnPlacement(ModRegistry.ARCHIVIST_ENTITY_TYPE.get(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                PatrollingMonster::checkPatrollingMonsterSpawnRules);
        context.registerSpawnPlacement(ModRegistry.BASHER_ENTITY_TYPE.get(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                PatrollingMonster::checkPatrollingMonsterSpawnRules);
        context.registerSpawnPlacement(ModRegistry.FIRECALLER_ENTITY_TYPE.get(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                PatrollingMonster::checkPatrollingMonsterSpawnRules);
        context.registerSpawnPlacement(ModRegistry.INQUISITOR_ENTITY_TYPE.get(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                PatrollingMonster::checkPatrollingMonsterSpawnRules);
        context.registerSpawnPlacement(ModRegistry.INVOKER_ENTITY_TYPE.get(),
                SpawnPlacements.Type.NO_RESTRICTIONS,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                Monster::checkMonsterSpawnRules);
        context.registerSpawnPlacement(ModRegistry.MARAUDER_ENTITY_TYPE.get(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                PatrollingMonster::checkPatrollingMonsterSpawnRules);
        context.registerSpawnPlacement(ModRegistry.PROVOKER_ENTITY_TYPE.get(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                PatrollingMonster::checkPatrollingMonsterSpawnRules);
        context.registerSpawnPlacement(ModRegistry.SORCERER_ENTITY_TYPE.get(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                PatrollingMonster::checkPatrollingMonsterSpawnRules);
        context.registerSpawnPlacement(ModRegistry.SURRENDERED_ENTITY_TYPE.get(),
                SpawnPlacements.Type.NO_RESTRICTIONS,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                Monster::checkMonsterSpawnRules);
        context.registerSpawnPlacement(ModRegistry.NECROMANCER_ENTITY_TYPE.get(),
                SpawnPlacements.Type.ON_GROUND,
                Heightmap.Types.MOTION_BLOCKING_NO_LEAVES,
                PatrollingMonster::checkPatrollingMonsterSpawnRules);
    }
    ...
    public void onRegisterCreativeModeTabs(CreativeModeTabContext context) {
        context.registerCreativeModeTab(CreativeModeTabConfigurator.from(MOD_ID)
                .icon(() -> new ItemStack(ModRegistry.HORN_OF_SIGHT_ITEM.get()))
